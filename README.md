...
The objective of 2048 is to create a tile of the target score, e.g., 2048, by sliding tiles up, left, right, down. Sliding tiles merges tiles of the same value to create a doubled tile.
